          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: "flex", justifyContent: "flex-end" }}>
              <FormControlLabel
                ...
                control={<MaterialUISwitch onClick={props.toggleTheme} sx={{ m: 1 }}  />}
                label=""
              />
              {/* <div className="form-check form-switch form-switch-lg">
                <input onChange={props.toggleTheme} className="form-check-input" type="checkbox" role="switch" id="switchSizeLarge" />
              </div> */}
              <Search>
                <SearchIconWrapper>
                  <SearchIcon />
